#!/bin/bash
# Smoke test 1-GPU per simulomicsr P4.
#
# Path: tutti relativi a /home/u0044/ (NON /mnt/home/u0044/) perche' su questo
# cluster i compute node (poddgx01/02/03) non montano /mnt/home/. Verificato
# col probe job 19720 su poddgx03 il 2026-05-07: /mnt/home/u0044 No such file.
#
# Submit:
#   sbatch /home/u0044/simulomicsr-dgx/runtime/smoke_1gpu.sh
#SBATCH --job-name=simulomicsr_smoke
...
# Source HF_TOKEN (necessario perche' --export=NONE blocca env inheritance).
...
if [ ! -f "${CONTAINER}" ]; then
    echo "FAIL: container ${CONTAINER} non trovato"
    exit 1
fi

...
| `70-fusioni-da-leggere.txt`, `90-adjudica.txt`, `80-da-leggere-identita.csv` | **SÌ come evidenza**: sono le 923 fusioni lette una per una, con le etichette. È il materiale che ha provato il 14,1%. |

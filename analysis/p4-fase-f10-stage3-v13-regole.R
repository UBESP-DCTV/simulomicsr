#!/usr/bin/env Rscript
# analysis/p4-fase-f10-stage3-v13-regole.R --- RE-CLUSTER Stadio 3 v13:
...
#       Rscript analysis/p4-fase-f10-stage3-v13-regole.R
#   FULL RUN (gate utente separato, ~8h; NON lanciare senza ok; usare setsid):
#       SMOKE=0 Rscript analysis/p4-fase-f10-stage3-v13-regole.R
...
cli::cli_h1(sprintf("Re-cluster Stadio 3 v13 (ancoraggio dal-contrasto + le sei regole del censimento 2026-07-28) -- modalita': %s",
...
suffix  <- if (SMOKE) sprintf("v13smoke-%s", run_id) else sprintf("v13-%s", run_id)
...
cli::cli_h2("SANITY v13 (overlay + bandiera)")
...
cli::cli_h2("SANITY v13 (ancoraggio dal-contrasto)")

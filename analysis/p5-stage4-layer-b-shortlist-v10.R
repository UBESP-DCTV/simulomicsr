# analysis/p5-stage4-layer-b-shortlist-v10.R
...
#
# Output: analysis/p4-output/layer-b-shortlist-v10.csv (paper-grade).
#
...
#
# Usage:
#   Rscript analysis/p5-stage4-layer-b-shortlist-v10.R
#
# Pre-requisiti:
#   - analysis/p4-output/layer-b-cluster-summary-v10.rds (rigenerato se manca)
#   - Layer A output v7 in /mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v7/
#     20260703T230632Z-stage4-v7-4f7ea215/
#   - Stage 3 output v7 in analysis/p4-output/20260720T180625Z-stage3-v10-364547a7/
...
summary_rds <- "analysis/p4-output/layer-b-cluster-summary-v10.rds"
out_csv    <- "analysis/p4-output/layer-b-shortlist-v10.csv"

# analysis/p4-fase-f5-stage4-layer-a-rebuild-v6.R --- RED ALERT FASE F6 (biologici).
# Layer A full run Stadio 4 sul NUOVO Stadio 3 v6 (recupero-nome biologici
# citochine+patogeni) + master v3.
#
# Differenze vs p5-stage4-layer-a-fullrun.R (96c43acb):
#   - stage3_dir  = 20260702T024122Z-stage3-v6-364547a7 (recovery biologici v6:
#     CYTOKINE_IMMPORT/PATHOGEN_TAXID/PAMP_WHITELIST/K3_MISTYPE_*, anchor v3.1.1)
...
#
# Usage (full): nohup Rscript analysis/p4-fase-f5-stage4-layer-a-rebuild-v6.R \
#   2>&1 | tee analysis/p4-fase-f5-stage4-layer-a-rebuild-v6.log &
...
cli_h1(paste0("Stadio 4 Layer A rebuild v6", if (DRY_RUN) " [DRY_RUN]" else ""))

stage3_dir  <- "analysis/p4-output/20260702T024122Z-stage3-v6-364547a7"
...
out_dir <- file.path("/mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v6",
  sprintf("%s-stage4-v6-%s", format(Sys.time(), "%Y%m%dT%H%M%SZ", tz = "UTC"),
...
cli_alert_success("Layer A rebuild v6 OK")

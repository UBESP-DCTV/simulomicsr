#!/usr/bin/env Rscript
# analysis/p4-fase-f12-stage3-v15-defrag.R --- RE-CLUSTER Stadio 3 v15:
...
#       Rscript analysis/p4-fase-f12-stage3-v15-defrag.R
#   FULL RUN (gate utente separato, ~8h; NON lanciare senza ok; usare setsid):
#       SMOKE=0 Rscript analysis/p4-fase-f12-stage3-v15-defrag.R
...
cli::cli_h1(sprintf("Re-cluster Stadio 3 v15 (ancoraggio dal-contrasto + le sei regole del censimento 2026-07-28) -- modalita': %s",
...
suffix  <- if (SMOKE) sprintf("v15smoke-%s", run_id) else sprintf("v15-%s", run_id)
...
cli::cli_h2("SANITY v15 (overlay + bandiera)")
...
cli::cli_h2("SANITY v15 (ancoraggio dal-contrasto)")

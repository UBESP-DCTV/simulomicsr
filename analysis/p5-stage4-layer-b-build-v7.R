# analysis/p5-stage4-layer-b-build-v7.R
# RE-SELECTION Layer B sul rework END-TO-END v7. Legge
# analysis/layer-b-selection-v7.csv (8 case study a label forte), esegue
# build_layer_b_results su Layer A v7, render report aggregato.
#
# Pre-requisiti:
#   - analysis/layer-b-selection-v7.csv compilato
#   - Layer A output v7 in
#     /mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v7/20260703T230632Z-stage4-v7-4f7ea215/
...
selection_csv <- "analysis/layer-b-selection-v7.csv"

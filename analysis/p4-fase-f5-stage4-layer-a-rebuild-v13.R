# analysis/p4-fase-f5-stage4-layer-a-rebuild-v13.R --- RE-POOL v13.
...
#   - out_dir -> simulomicsr-stage4-v13, token -stage4-v13-.
#
...
out_dir <- file.path("/mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v13",
  sprintf("%s-stage4-v13-%s", format(Sys.time(), "%Y%m%dT%H%M%SZ", tz = "UTC"),

#!/usr/bin/env Rscript
# p4-fase-f3-rescue-stage2-full.R --- F3 H3 retry tutti i cs25 chunks derivati
# dai 36 stage2 fail. Adattato da analysis/p4-beta-rescue-h3-stage2-full.R.
# Submit-only, resume-safe via job RDS.
...
INPUT      <- "analysis/input/archs4-human-stage2-rescue-cs25-v2.jsonl"
SLUG       <- "f3-rescue-stage2"
...
cat(sprintf("Stage2 cs25 rescue records: %d\n", n_records))
...
cat("ETA: ~10-30 min wall (~59 chunk cs25).\n")

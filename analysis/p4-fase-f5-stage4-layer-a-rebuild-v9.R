# analysis/p4-fase-f5-stage4-layer-a-rebuild-v9.R --- RED ALERT FASE F6 v9.
# Layer A full run Stadio 4 v9 sullo Stadio 3 v9-final (recupero-nome
# perturbativo B, name-cleanup Mistral applicato) + master v3, MEDESIMO ramo
# di pooling `rem_group` (meta-analisi cross-studio nominate L2-L4) di v8.
#
...
#     infra tra stadi).
#   - out_dir -> simulomicsr-stage4-v9, token -stage4-v9-.
#
# Config invariata vs v8 (uniformity): MEGA-AUG bidirezionale,
...
#
# Usage (full, detached): STAGE3_DIR=<dir Stadio 3 v9-final> setsid \
#   Rscript analysis/p4-fase-f5-stage4-layer-a-rebuild-v9.R \
#   > analysis/p4-fase-f5-stage4-layer-a-rebuild-v9.log 2>&1 < /dev/null &
...
cli_h1(paste0("Stadio 4 Layer A rebuild v9 (Stadio 3 v9-final, ramo rem_group)", if (DRY_RUN) " [DRY_RUN]" else ""))
...
out_dir <- file.path("/mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v9",
  sprintf("%s-stage4-v9-%s", format(Sys.time(), "%Y%m%dT%H%M%SZ", tz = "UTC"),
...
cli_alert_success("Layer A rebuild v9 OK")

# analysis/p4-fase-f5-stage4-layer-a-rebuild-v7.R --- RED ALERT FASE F6 (biologici).
# Layer A full run Stadio 4 sul NUOVO Stadio 3 v7 (biologici + fix estrazione
# pathogen dose/tempo/verbo, commit 1fb1520) + master v3.
#
# Differenze vs p5-stage4-layer-a-fullrun.R (96c43acb):
#   - stage3_dir  = 20260703T113045Z-stage3-v7-364547a7 (v7: PATHOGEN_VERNACULAR/
#     PAMP su ×2-3 vs v6, cache lookup v4; anchor v3.1.1)
...
cli_h1(paste0("Stadio 4 Layer A rebuild v7", if (DRY_RUN) " [DRY_RUN]" else ""))
...
out_dir <- file.path("/mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v7",
  sprintf("%s-stage4-v7-%s", format(Sys.time(), "%Y%m%dT%H%M%SZ", tz = "UTC"),
...
cli_alert_success("Layer A rebuild v7 OK")

#!/usr/bin/env Rscript
# analysis/p4-fase-f11-stage3-v14-defrag.R --- RE-CLUSTER Stadio 3 v14:
...
#       Rscript analysis/p4-fase-f11-stage3-v14-defrag.R
#   FULL RUN (gate utente separato, ~8h; NON lanciare senza ok; usare setsid):
#       SMOKE=0 Rscript analysis/p4-fase-f11-stage3-v14-defrag.R
...
suffix  <- if (SMOKE) sprintf("v14smoke-%s", run_id) else sprintf("v14-%s", run_id)

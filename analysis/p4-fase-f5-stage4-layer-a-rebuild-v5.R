...
#   - stage3_dir  = 20260627T033447Z-stage3-v4-364547a7 (master v3, completeness
#     guard, anchor v3.1.1)
...
cli_h1(paste0("Stadio 4 Layer A rebuild v5", if (DRY_RUN) " [DRY_RUN]" else ""))
...
out_dir <- file.path("/mnt/wwn-0x5000039d58caca35/simulomicsr-stage4-v5",
  sprintf("%s-stage4-v5-%s", format(Sys.time(), "%Y%m%dT%H%M%SZ", tz = "UTC"),
...
cli_alert_success("Layer A rebuild v5 OK")
